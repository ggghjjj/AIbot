...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
    ...
    <router-link class="navbar-brand" :to="{name: 'home'}">蛇蛇</router-link>
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <router-link :class="route_name== 'ranklist_index' ?  'nav-link active' : 'nav-link'" :to="{name: 'ranklist_index'}">对战列表</router-link>
        </li>
        <li class="nav-item">
